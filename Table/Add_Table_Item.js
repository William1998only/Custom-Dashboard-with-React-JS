...
export class Add_Table_Item extends Component {
  constructor(props) {
    super(props);
    this.state = {
      input: {},
  ...
  componentDidMount(){
    ...
    if (this.state.option == '3 Column') {
        axios.get('http://localhost:3001/menu_table_3/' + this.props.match.params.Email + '/' + this.props.match.params.menu_name)
        .then(res => {
                const menu = res.data;
                const count = res.data.length;
                if (count != 0) {
                        this.setState({ 
                            column1: menu[0].col_1,
                            column2: menu[0].col_2,
                            column3: menu[0].col_3
                        })
                    console.log(menu[0].col_1);
                    // console.log(menu.col_1 + 'tes');
                    console.log(count);
                }
  ...
  handleInputChange_Column(evt){
    ...
    if (this.state.option == '3 Column') {
        ...
        axios.get('http://localhost:3001/menu_table_4/' + this.props.match.params.Email + '/' + this.props.match.params.menu_name)
        .then(res => {
                const menu = res.data;
                const count = res.data.length;
                if (count != 0) {
  ...
  onFormSubmit1(){
    ...
    //   });
      ...
      axios.post('http://localhost:3001/Add_Item_Table_3/' +  this.props.match.params.Email + '/' + this.props.match.params.menu_name, serverport)
      .then(res => console.log(res.data));
      this.setState({
          menu_name: '',
          col_1: '',
  ...
  onFormSubmit2(){
    ...
    //   });
      ...
      axios.post('http://localhost:3001/Add_Item_Table_4/' +  this.props.match.params.Email + '/' + this.props.match.params.menu_name, serverport)
      .then(res => console.log(res.data));
      this.setState({
          menu_name: '',
          col_1: '',
  ...
  render() {
    if(this.state.option == '3 Column'){
        ...
        <div className="App">
            <div className="row">
                <div class="comment-form-wrap pt-5">
                    <h3 class="mb-5">Add Item to Your 3 Column Table </h3>
                    ...
                    <div class="form-group pt-5">
                        <label for="col_1">{this.state.column1}</label>
                    ...
                    <div class="form-group pt-5">
                        <label for="col_1">{this.state.column2}</label>
                    ...
                    <div class="form-group pt-5">
                        <label for="col_1">{this.state.column3}</label>
        ...
        <div className="App">
            <div className="row">
                <div class="comment-form-wrap pt-5">
                    <h3 class="mb-5">Add Item to Your 4 Column Table</h3>
                    <form action="#" class="p-5 bg-light">
                    <div class="form-group">
                        <label for="name">Table</label>
                        <select className="form-control" name="name" value={this.state.input} onChange={this.handleInputChange_Column}>
                    ...
                    <div class="form-group pt-5">
                        <label for="col_2">{this.state.column2}</label>
                        <div className="error"><font color="red">{this.state.error.col_2}</font></div>
                        <input type="text" class="form-control" name="col_2" value={this.state.input.col_2}
                        onChange={this.handleInputChange}/>
                    </div>
                    <div class="form-group pt-5">
                        <label for="col_3">{this.state.column3}</label>
                        <div className="error"><font color="red">{this.state.error.col_3}</font></div>
                        <input type="text" class="form-control" name="col_3" value={this.state.input.col_3}
                        onChange={this.handleInputChange}/>
                    </div>
                    <div class="form-group pt-5">
                        <label for="col_4">{this.state.column4}</label>
